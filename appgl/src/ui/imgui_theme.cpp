...
//
// From: https://github.com/pthom/hello_imgui/blob/master/src/hello_imgui/impl/imgui_theme.cpp
//
...
namespace ImGuiTheme
{
    ...
    ThemeInfo gThemeInfos[] = {
        {Theme::ImGuiColorsClassic,    "ImGuiColorsClassic",  ThemesImpl::ImGui_StyleColorsClassic() },
        {Theme::ImGuiColorsLight,      "ImGuiColorsLight",    ThemesImpl::ImGui_StyleColorsLight() },
        {Theme::ImGuiColorsDark,       "ImGuiColorsDark",     ThemesImpl::ImGui_StyleColorsDark()},
        {Theme::MaterialFlat,          "MaterialFlat",        ThemesImpl::MaterialFlat()},
        {Theme::PhotoshopStyle,        "PhotoshopStyle",      ThemesImpl::PhotoshopStyle()},
        {Theme::GrayVariations,        "GrayVariations",        ThemesImpl::ShadesOfGray(3.f, 1.f, 1.f)},
        {Theme::GrayVariations_Darker, "GrayVariations_Darker",  ThemesImpl::ShadesOfGray(3.f, 1.136f, 0.865f)},
        {Theme::MicrosoftStyle,        "MicrosoftStyle",      ThemesImpl::MicrosoftStyle()},
        {Theme::Cherry,                "Cherry",              ThemesImpl::Cherry()},
        {Theme::Darcula,               "Darcula",             ThemesImpl::Darcula()},
        {Theme::DarculaDarker,         "DarculaDarker",       ThemesImpl::DarculaDarker()},
        {Theme::LightRounded,          "LightRounded",        ThemesImpl::LightRounded()},
        {Theme::SoDark_AccentBlue,     "SoDark_AccentBlue",   ThemesImpl::SoDark(0.548f)},
        {Theme::SoDark_AccentYellow,   "SoDark_AccentYellow", ThemesImpl::SoDark(0.163f)},
        {Theme::SoDark_AccentRed,      "SoDark_AccentRed",    ThemesImpl::SoDark(0.f)},
        {Theme::BlackIsBlack,          "BlackIsBlack",        ThemesImpl::BlackIsBlack()},
        {Theme::WhiteIsWhite,          "WhiteIsWhite",        ThemesImpl::WhiteIsWhite()},
    };

    const char* ImGuiTheme_Name(Theme theme)
    {
        IM_ASSERT(((int)theme >= 0) && (theme < Theme::Count));
    ...
    Theme ImGuiTheme_FromName(const char* themeName)
    {
        ...
        return Theme::ImGuiColorsClassic;
    }
    ...
    bool _ShowThemeSelector(Theme* theme)
    {
        bool changed = false;
        ImVec2 listboxSize =  ImVec2(0.f, static_cast<float>(Theme::Count) * (ImGui::GetFontSize() + ImGui::GetStyle().ItemInnerSpacing.y));
        if (ImGui::BeginListBox("Available_themes", listboxSize))
        {
            for (size_t i = 0; i < static_cast<int>(Theme::Count); ++i)
            {
                Theme theme_i = (Theme)(i);
...
Note:
   This theme tweaks window is a part of HelloImGuI, but can be reused: see
    ...
    {
        bool changed = false;
        if (ImGui::BeginTabBar("Theme Tweak GUI"))
        {
